...
Answers "how many players", "can you pick your realm", and "when is the dev
...
strings: `"Where is the team info in netgame?"`, `"hmm..keves a map :-o"`
(Hungarian).
...
Single-player never sets `+0x2c`. `THEOC_CONSOLE=1` sidesteps the gate entirely
