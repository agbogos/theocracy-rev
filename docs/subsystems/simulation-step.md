...
- **Still traveling**: interpolate the entity's **x/y position** (`entry+0x52`/`+0x56`) toward the next node (`FUN_082d1230`).
...
- Province struct: map fields around `+0x40aae` (owner), `+0x103a1`; confirm province record size/stride.
