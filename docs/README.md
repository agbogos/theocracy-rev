...
| In-game calendar | **done 2026-08-05** — read off `theocracy.real`, not inferred: the `cDate` class, the 20-day/365-day constants traced to the instructions that build them, the 4-byte save field, and the 19th month the arithmetic produces and the UI prints ([subsystems/calendar.md](subsystems/calendar.md)). Findings written back to the Ghidra DB as renames and comments. What remains is how a tick becomes a day |
