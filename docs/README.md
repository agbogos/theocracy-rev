...
| **Windows port** | not started — structure only, in [porting/other-os-ports.md](porting/other-os-ports.md). Top risk is sub-millisecond sleep against a ~15.6 ms scheduler; it runs the *Linux* binary, for the reasons that doc gives |
