...
const std::set<std::string> kKnown = {
    ...
    "THEOC_PROVINCE_MS", "THEOC_MUSIC_VOL", "THEOC_AUDIO_MS", "THEOC_LEGACY_AUDIOQ", "THEOC_SKIP_MOVIES",
    "THEOC_VIDEO_HOLD",
    // paths
    ...
    "THEOC_LEGACY_SLEEP", "THEOC_LEGACY_SPRITE", "THEOC_LEGACY_ASYNCBG",
    "THEOC_NATIVE_BLIT",
    "THEOC_NO_SAVE_FIX", "THEOC_START_ANYWAY",
    // diagnostics
    "THEOC_VERBOSE", "THEOC_FPS", "THEOC_WATCHDOG", "THEOC_WATCHDOG_SAMPLE", "THEOC_SLOWLOG",
    "THEOC_PROFILE", "THEOC_ICALL", "THEOC_ICALL_OUT", "THEOC_TRACE", "THEOC_KEYLOG", "THEOC_CD_TRACE",
    "THEOC_REPORT_CLICKS", "THEOC_LOUD_ABORT", "THEOC_ABORT_CAP", "THEOC_RESUME_TEST",
    "THEOC_START_SEC", "THEOC_LONGRUN", "THEOC_DUMP_WORLD", "THEOC_WORLD_FILE",
    "THEOC_NEW_WORLD", "THEOC_WORLD_OUT",
    // test harness
